...
class LungeAnalyzer:
    ...
    The analyzer uses the selected leg as the
    primary tracking leg.
    """
    ...
    def analyze(self, landmarks):
        ...
        Returns:
            dict containing the current lunge analysis.
        """
        ...
        if angle <= self.down_threshold:
            self.form_feedback = "Lunge depth reached"
    ...
    def get_result(self):
        """
        Return the latest lunge analysis result.
        """
